    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        @media(max-width:640px){.ats-grid{grid-template-columns:1fr!important;} .ats-section{padding:48px 16px 64px!important;}}
        @media(max-width:480px){.ats-grid{grid-template-columns:1fr!important;} .ats-section{padding:32px 12px 48px!important;}}
      `}</style>
      ...
      <div style={{
        ...
        <section className="ats-section" style={{ maxWidth: 1280, margin: "0 auto", padding: "clamp(48px, 8vw, 88px) clamp(16px, 5vw, 56px) clamp(64px, 10vw, 108px)" }}>
