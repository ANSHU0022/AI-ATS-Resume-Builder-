                        ...
                        {leftTab === "cv" ? (
                            ...
                            <>
                                ...
                                <button onClick={generateCoverLetter} disabled={clLoading} className="cl-generate-btn">
                                    {clLoading
                                        ? <><span>⏳</span> Groq AI is writing your cover letter...</>
                                        : <><span>✨</span> Generate Cover Letter with AI</>
                                    }
                                </button>
                        ...
                        <div className="cl-page-wrap">
                            ...
                            {clTemplate === "executive" && (
                                <div className="cl-paper cl-executive">
                                    ...
                                    {clLoading && <div className="cl-loading-text">✨ Groq AI is crafting your cover letter...</div>}
