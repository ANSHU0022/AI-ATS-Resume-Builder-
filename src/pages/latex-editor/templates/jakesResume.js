export const jakesResume = `\\documentclass[letterpaper,11pt]{article}
...
\\section{Projects}
    \\resumeSubHeadingListStart
      \\resumeProjectHeading
          ...
          \\resumeItemListEnd
      \\resumeProjectHeading
          {\\textbf{Simple Paint} $|$ \\emph{Java, Eclipse, JIG}}{May 2018 -- May 2020}
          \\resumeItemListStart
            \\resumeItem{Developed a simple paint program with GUI features using Java}
            \\resumeItem{Implemented features like drawing shapes, selecting colors, and saving/loading images}
          \\resumeItemListEnd
    \\resumeSubHeadingListEnd
