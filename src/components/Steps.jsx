...
const StepsTimeline = () => {
  ...
  useEffect(() => {
    STEPS.forEach((s, i) => {
      setTimeout(() => setVis(prev => { const n = [...prev]; n[i] = true; return n; }), s.delay);
    });
  }, []);
  ...
  return (
    <div style={{ position: "relative", display: "flex", flexDirection: "column", gap: 0 }}>
      ...
      <div style={{
        ...
        bottom: D / 2,              // end at top edge of last circle
        width: 2,
      ...
      {STEPS.map((s, i) => (
        <div
          ...
          style={{
            ...
            opacity: vis[i] ? 1 : 0,
            transform: vis[i] ? "translateX(0)" : "translateX(22px)",
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 1220, margin: "0 auto", width: "100%" }}>
          <div className="hiw-wrap" style={{ display: "flex", alignItems: "center", gap: 72 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ marginTop: 38 }}>
                <a href="#"
                  style={{ display: "inline-flex", alignItems: "center", gap: 8, fontSize: 14, fontWeight: 700, color: "#7c5cbf", textDecoration: "none", borderBottom: "2px solid rgba(124,92,191,0.3)", paddingBottom: 2, fontFamily: "'Sora',sans-serif" }}
